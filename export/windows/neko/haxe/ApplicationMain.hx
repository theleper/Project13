...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "RunningW", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "RunningW";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "RunningW", null, { width: 440, height: 220 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 440, height: 220 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 440, 220, "null");
		#end
		#else
		create ();
		#end

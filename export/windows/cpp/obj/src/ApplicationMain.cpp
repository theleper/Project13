...
HXLINE(  29)		::openfl::_legacy::Lib_obj::setPackage(HX_("",00,00,00,00),HX_("RunningW",98,8d,88,ea),HX_("com.example.myapp",84,30,57,c1),HX_("0.0.1",35,3d,c8,c1));
HXLINE(  52)		::openfl::_legacy::Lib_obj::create( ::Dynamic(new _hx_Closure_0()),(int)440,(int)220,(int)60,(int)0,((int)((int)((int)((int)((int)((int)((int)((int)((int)((int)::openfl::_legacy::Lib_obj::HARDWARE | (int)::openfl::_legacy::Lib_obj::ALLOW_SHADERS) | (int)(int)0) | (int)(int)0) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::RESIZABLE) | (int)(int)0) | (int)::openfl::_legacy::Lib_obj::VSYNC) | (int)(int)0) | (int)(int)0) | (int)(int)0),HX_("RunningW",98,8d,88,ea),null(),null());
            	}

...
HX_DEFINE_STACK_FRAME(_hx_pos_fb0a5c0944376249_512_new,"__ASSET__flixel_fonts_monsterrat_ttf","new",0x5ab5a7f2,"__ASSET__flixel_fonts_monsterrat_ttf.new","DefaultAssetLibrary.hx",512,0x0fc48912)
...
::String filename = __o_filename.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_fb0a5c0944376249_512_new)
HXDLIN( 512)		super::__construct(filename,style,type);
            	}

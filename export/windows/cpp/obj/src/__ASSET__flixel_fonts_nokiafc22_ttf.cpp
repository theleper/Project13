...
HX_DEFINE_STACK_FRAME(_hx_pos_8c395429170d5493_511_new,"__ASSET__flixel_fonts_nokiafc22_ttf","new",0x22f03f2a,"__ASSET__flixel_fonts_nokiafc22_ttf.new","DefaultAssetLibrary.hx",511,0x0fc48912)
...
::String filename = __o_filename.Default(HX_HCSTRING("","\x00","\x00","\x00","\x00"));
            	HX_STACKFRAME(&_hx_pos_8c395429170d5493_511_new)
HXDLIN( 511)		super::__construct(filename,style,type);
            	}

...
HX_LOCAL_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_115_update,"flixel.system.debug.watch.Watch","update",0x283e266f,"flixel.system.debug.watch.Watch.update","flixel/system/debug/watch/Watch.hx",115,0x446c9b58)
HX_LOCAL_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_120_updateSize,"flixel.system.debug.watch.Watch","updateSize",0x79f056d0,"flixel.system.debug.watch.Watch.updateSize","flixel/system/debug/watch/Watch.hx",120,0x446c9b58)
HX_LOCAL_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_130_resetEntries,"flixel.system.debug.watch.Watch","resetEntries",0x423b6427,"flixel.system.debug.watch.Watch.resetEntries","flixel/system/debug/watch/Watch.hx",130,0x446c9b58)
HX_LOCAL_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_140_getMaxNameWidth,"flixel.system.debug.watch.Watch","getMaxNameWidth",0x1ee45d07,"flixel.system.debug.watch.Watch.getMaxNameWidth","flixel/system/debug/watch/Watch.hx",140,0x446c9b58)
HX_LOCAL_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_145_getMaxMinWidth,"flixel.system.debug.watch.Watch","getMaxMinWidth",0x4606f748,"flixel.system.debug.watch.Watch.getMaxMinWidth","flixel/system/debug/watch/Watch.hx",145,0x446c9b58)
HX_LOCAL_STACK_FRAME(_hx_pos_f3919820c0c3a2ee_149_getMax,"flixel.system.debug.watch.Watch","getMax",0x445ae414,"flixel.system.debug.watch.Watch.getMax","flixel/system/debug/watch/Watch.hx",149,0x446c9b58)
...
HXDLIN( 108)			::Array< ::Dynamic> _g1 = this->entries->copy();
HXDLIN( 108)			while((_g < _g1->length)){
HXLINE( 108)				 ::flixel::_hx_system::debug::watch::WatchEntry entry = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXDLIN( 115)		::Array< ::Dynamic> _g1 = this->entries;
HXDLIN( 115)		while((_g < _g1->length)){
HXDLIN( 115)			 ::flixel::_hx_system::debug::watch::WatchEntry entry = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXDLIN( 130)		int _g1 = (int)0;
HXDLIN( 130)		int _g = this->entries->length;
HXDLIN( 130)		while((_g1 < _g)){
HXDLIN( 130)			_g1 = (_g1 + (int)1);
HXDLIN( 130)			int i = (_g1 - (int)1);
HXLINE( 132)			 ::flixel::_hx_system::debug::watch::WatchEntry entry = this->entries->__get(i).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
...
HXDLIN( 140)			return entry->getNameWidth();
            		}
            		HX_END_LOCAL_FUNC1(return)

            	HX_STACKFRAME(&_hx_pos_f3919820c0c3a2ee_140_getMaxNameWidth)
HXDLIN( 140)		return this->getMax( ::Dynamic(new _hx_Closure_0()));
            	}
...
HXDLIN( 145)			return entry->getMinWidth();
            		}
            		HX_END_LOCAL_FUNC1(return)
...
HXLINE( 150)		Float max = ((Float)0.0);
HXLINE( 151)		{
HXLINE( 151)			int _g = (int)0;
HXDLIN( 151)			::Array< ::Dynamic> _g1 = this->entries;
HXDLIN( 151)			while((_g < _g1->length)){
HXLINE( 151)				 ::flixel::_hx_system::debug::watch::WatchEntry entry = _g1->__get(_g).StaticCast<  ::flixel::_hx_system::debug::watch::WatchEntry >();
HXDLIN( 151)				_g = (_g + (int)1);
HXLINE( 153)				Float value = ( (Float)(getValue(entry)) );

...
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_804_update,"flixel.ui.FlxBar","update",0xdbe594ee,"flixel.ui.FlxBar.update","flixel/ui/FlxBar.hx",804,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_823_draw,"flixel.ui.FlxBar","draw",0x9cd647a9,"flixel.ui.FlxBar.draw","flixel/ui/FlxBar.hx",823,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_867_set_pixels,"flixel.ui.FlxBar","set_pixels",0x3c70e2cf,"flixel.ui.FlxBar.set_pixels","flixel/ui/FlxBar.hx",867,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_879_toString,"flixel.ui.FlxBar","toString",0x909c22d1,"flixel.ui.FlxBar.toString","flixel/ui/FlxBar.hx",879,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_889_get_percent,"flixel.ui.FlxBar","get_percent",0x8cbbddd7,"flixel.ui.FlxBar.get_percent","flixel/ui/FlxBar.hx",889,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_899_set_percent,"flixel.ui.FlxBar","set_percent",0x9728e4e3,"flixel.ui.FlxBar.set_percent","flixel/ui/FlxBar.hx",899,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_908_set_value,"flixel.ui.FlxBar","set_value",0x282d560f,"flixel.ui.FlxBar.set_value","flixel/ui/FlxBar.hx",908,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_939_get_value,"flixel.ui.FlxBar","get_value",0x44dc6a03,"flixel.ui.FlxBar.get_value","flixel/ui/FlxBar.hx",939,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_943_set_numDivisions,"flixel.ui.FlxBar","set_numDivisions",0x1f308ca2,"flixel.ui.FlxBar.set_numDivisions","flixel/ui/FlxBar.hx",943,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_950_get_frontFrames,"flixel.ui.FlxBar","get_frontFrames",0xa222c541,"flixel.ui.FlxBar.get_frontFrames","flixel/ui/FlxBar.hx",950,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_959_set_frontFrames,"flixel.ui.FlxBar","set_frontFrames",0x9dee424d,"flixel.ui.FlxBar.set_frontFrames","flixel/ui/FlxBar.hx",959,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_974_get_backFrames,"flixel.ui.FlxBar","get_backFrames",0x7b96195b,"flixel.ui.FlxBar.get_backFrames","flixel/ui/FlxBar.hx",974,0x9c56c8d5)
HX_LOCAL_STACK_FRAME(_hx_pos_29953dbeb33e4775_983_set_backFrames,"flixel.ui.FlxBar","set_backFrames",0x9bb601cf,"flixel.ui.FlxBar.set_backFrames","flixel/ui/FlxBar.hx",983,0x9c56c8d5)
namespace flixel{
namespace ui{
...
HXLINE( 787)					int prct = ::Std_obj::_hx_int(percent);
HXLINE( 788)					{
HXLINE( 788)						 ::flixel::math::FlxRect _this = this->_filledFlxRect;
HXDLIN( 788)						 ::openfl::_legacy::geom::Rectangle FlashRect = this->_filledBarRect;
...
HXDLIN( 788)						 ::flixel::math::FlxRect _this1 = _this;
HXDLIN( 788)						_this1->x = ::Math_obj::round(_this1->x);
HXDLIN( 788)						_this1->y = ::Math_obj::round(_this1->y);
HXDLIN( 788)						_this1->width = ::Math_obj::round(_this1->width);
HXDLIN( 788)						_this1->height = ::Math_obj::round(_this1->height);
            					}
...
HXDLIN( 834)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN( 834)			while((_g < _g1->length)){
HXLINE( 834)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
...
HXLINE( 850)					 ::flixel::math::FlxMatrix _this = this->_matrix;
HXDLIN( 850)					Float cos = this->_cosAngle;
HXDLIN( 850)					Float sin = this->_sinAngle;
HXDLIN( 850)					Float a1 = (_this->a * cos);
HXDLIN( 850)					Float a11 = (a1 - (_this->b * sin));
HXDLIN( 850)					Float _hx_tmp3 = (_this->a * sin);
HXDLIN( 850)					_this->b = (_hx_tmp3 + (_this->b * cos));
HXDLIN( 850)					_this->a = a11;
HXDLIN( 850)					Float c1 = (_this->c * cos);
HXDLIN( 850)					Float c11 = (c1 - (_this->d * sin));
HXDLIN( 850)					Float _hx_tmp4 = (_this->c * sin);
HXDLIN( 850)					_this->d = (_hx_tmp4 + (_this->d * cos));
HXDLIN( 850)					_this->c = c11;
HXDLIN( 850)					Float tx1 = (_this->tx * cos);
HXDLIN( 850)					Float tx11 = (tx1 - (_this->ty * sin));
HXDLIN( 850)					Float _hx_tmp5 = (_this->tx * sin);
HXDLIN( 850)					_this->ty = (_hx_tmp5 + (_this->ty * cos));
HXDLIN( 850)					_this->tx = tx11;
            				}
HXLINE( 853)				{
HXLINE( 853)					 ::flixel::math::FlxPoint _this1 = this->_point;
HXDLIN( 853)					Float Y = this->origin->y;
HXDLIN( 853)					{
HXLINE( 853)						 ::flixel::math::FlxPoint _g2 = _this1;
HXDLIN( 853)						_g2->set_x((_g2->x + this->origin->x));
            					}
HXDLIN( 853)					{
HXLINE( 853)						 ::flixel::math::FlxPoint _g3 = _this1;
HXDLIN( 853)						_g3->set_y((_g3->y + Y));
            					}
            				}
HXLINE( 854)				if (this->isPixelPerfectRender(camera)) {
HXLINE( 856)					 ::flixel::math::FlxPoint _this2 = this->_point;
...
HXDLIN( 880)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 880)		_this->label = HX_("min",92,11,53,00);
HXDLIN( 880)		_this->value = value;
HXDLIN( 880)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
HXLINE( 881)		 ::Dynamic value1 = this->max;
HXDLIN( 881)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 881)		_this1->label = HX_("max",a4,0a,53,00);
HXDLIN( 881)		_this1->value = value1;
HXDLIN( 881)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
HXLINE( 882)		 ::Dynamic value2 = this->range;
HXDLIN( 882)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 882)		_this2->label = HX_("range",bd,a5,1f,e4);
HXDLIN( 882)		_this2->value = value2;
HXDLIN( 882)		 ::flixel::util::LabelValuePair _hx_tmp2 = _this2;
HXLINE( 883)		 ::Dynamic value3 = this->pct;
HXDLIN( 883)		 ::flixel::util::LabelValuePair _this3 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 883)		_this3->label = HX_("%",25,00,00,00);
HXDLIN( 883)		_this3->value = value3;
HXDLIN( 883)		 ::flixel::util::LabelValuePair _hx_tmp3 = _this3;
HXLINE( 884)		 ::Dynamic value4 = this->pxPerPercent;
HXDLIN( 884)		 ::flixel::util::LabelValuePair _this4 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 884)		_this4->label = HX_("px/%",1e,1d,63,4a);
HXDLIN( 884)		_this4->value = value4;
HXDLIN( 884)		 ::flixel::util::LabelValuePair _hx_tmp4 = _this4;
HXLINE( 885)		 ::Dynamic value5 = this->get_value();
HXDLIN( 885)		 ::flixel::util::LabelValuePair _this5 = ::flixel::util::LabelValuePair_obj::_pool->get();
HXDLIN( 885)		_this5->label = HX_("value",71,7f,b8,31);
HXDLIN( 885)		_this5->value = value5;
HXLINE( 879)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(6)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_hx_tmp2)->init(3,_hx_tmp3)->init(4,_hx_tmp4)->init(5,_this5));
            	}
...
HXDLIN( 895)		return ::Math_obj::floor((((Float)(_hx_tmp1 - this->min) / (Float)this->range) * this->_maxPercent));
            	}
...
HXDLIN( 909)		this->value = ::Math_obj::max(_hx_tmp,::Math_obj::min(newValue,this->max));
HXLINE( 911)		bool _hx_tmp1;
HXDLIN( 911)		Float _hx_tmp2 = this->get_value();
HXDLIN( 911)		if ((_hx_tmp2 == this->min)) {
HXLINE( 911)			_hx_tmp1 = hx::IsNotNull( this->emptyCallback );
            		}
            		else {
...
HXDLIN( 916)		Float _hx_tmp4 = this->get_value();
HXDLIN( 916)		if ((_hx_tmp4 == this->max)) {
HXLINE( 916)			_hx_tmp3 = hx::IsNotNull( this->filledCallback );
            		}
            		else {
...
HXDLIN( 921)		Float _hx_tmp6 = this->get_value();
HXDLIN( 921)		if ((_hx_tmp6 == this->min)) {
HXLINE( 921)			_hx_tmp5 = this->killOnEmpty;
            		}
            		else {

...
HXDLIN(1090)		if (::flixel::FlxG_obj::renderBlit) {
...
HXDLIN(1103)		if (::flixel::FlxG_obj::renderBlit) {
...
HXDLIN(1235)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
HXDLIN(1240)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
HXDLIN(1245)		return (this->debugBoundingBoxColorPartial = color);
            	}
